...
@patch("mafm.sumstats.munge_chr")
@patch("mafm.sumstats.munge_bp")
@patch("mafm.sumstats.munge_allele")
@patch("mafm.sumstats.make_SNPID_unique")
@patch("mafm.sumstats.munge_pvalue")
@patch("mafm.sumstats.munge_beta")
@patch("mafm.sumstats.munge_se")
@patch("mafm.sumstats.munge_eaf")
@patch("mafm.sumstats.munge_maf")
@patch("mafm.sumstats.munge_rsid")
@patch("mafm.sumstats.check_colnames")
